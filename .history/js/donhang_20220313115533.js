window.addEventListener("load",function() {
    ...
    const sumMOney = document.querySelector(".tbody");
    const moneyck = document.querySelector(".tbody");
    const monbeyT = document.querySelector(".tbody");
    const moneyLast = document.querySelector(".tbody");

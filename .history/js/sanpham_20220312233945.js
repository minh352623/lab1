    ...
    function renderItem(item){
        ...
        <form class="product-child" data-id="${item.id}">
            ...
            <div class="product__info">
                ...
                <span class="price" name="price">Giá: ${item.price}</span>
                <div class="product__info-oder">
                    <span>Số Lượng:</span>
                    <input type="text" name="soluong" class=">
    ...
    for(let i = 0; i<col.length;i++){
        col[i].addEventListener("click",function(e){
            ...
            if(e.target.matches(".submit")){
                ...
                console.log(form);
                const img = form.querySelector(".product__img img").src;
                const name = form.querySelector(".product__header-center").src;
                const number = form.querySelector(".product__img img").src;
                const price = form.querySelector(".product__img img").src;
